    ...
    <template v-slot:gHeader>
      <view style="height: 44px" class="gui-flex">
        ...
        <view class="gui-flex gui-row gui-wrap gui-align-items-center">
          <text
            class="gui-icons gui-block gui-color-drak gui-p-10 gui-b-50 gui-bg-black4 gui-m-r-10"
            >&#xe69e;</text
          >
          <text
            class="gui-icons gui-block gui-color-drak gui-p-10 gui-b-50 gui-bg-black4"
            >&#xe6c7;</text
          >
        </view>
    ...
    <template v-slot:gBody>
      <view class="gui-flex gui-m-l-20 gui-m-b-20">
        <view class="gui-bg-white gui-dark-bg-level-3 gui-p-r-20"
          ...
          ></gui-switch-navigation
        ></view>
        <view class="gui-m-l-10 gui-m-t-5">
          <text
            class="gui-icons gui-block gui-color-drak gui-p-10 gui-b-100 gui-bg-black4"
            >&#xe614;</text
          >
        </view>
      </view>
      ...
      <view
        class="gui-margin-top gui-flex gui-row gui-space-between gui-m-l-20 gui-m-r-20"
      >
        <view
          class="gui-block gui-dark-bg-level-3 gui-color-drak gui-flex gui-row gui-align-items-center gui-justify-content-center"
      ...
      <view
        class="gui-margin-top gui-padding-x gui-flex gui-row gui-wrap gui-space-between"
      >
        <view
          class="gui-product"
          hover-class="gui-tap"
        ...
        >
          ...
          <view class="gui-product-lines">
            <text class="gui-product-name gui-primary-text">{{
              item.name
            }}</text>
          </view>
...
const requestDemo = async () => {
  ...
  try {
    // 请求成功
    let res = await uni.gRequest.get(
      "/album/category/getBaseCategoryList",
      {},
      false
    );
    console.log(res);
