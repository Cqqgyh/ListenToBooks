		...
		<template v-slot:gBody>
			<view class="gui-flex gui-m-l-20 gui-m-b-20">
				...
				<view class="gui-m-l-10 gui-m-t-5">
					<text class="gui-icons gui-block gui-color-drak gui-p-10 gui-b-100 gui-bg-black4">&#xe614;</text>
				</view>
			</view>
			...
			<view class="gui-margin-top gui-flex gui-row gui-space-between  gui-m-l-20  gui-m-r-20">
				<view class="gui-block gui-dark-bg-level-3 gui-color-drak gui-flex gui-row gui-align-items-center gui-justify-content-center" style="font-weight: 900;">
			...
			<view style="padding-top:50rpx;" class="gui-relative">
				<gui-flex :customClass="['gui-footer']" direction="row" :wrap="false" alignItems="center">
					<view class="gui-footer-icon-buttons" @tap="navChange(0)">
						<text :class="[currentIndex == 0 ? 'gui-primary-color' : 'gui-color-gray', 'gui-icons', 'gui-footer-icon-buttons-icon', 'gui-block']">&#xe608;
</text>
					...
					<view class="gui-footer-icon-buttons" @tap="navChange(4)">
						<text :class="[currentIndex == 4 ? 'gui-primary-color' : 'gui-color-gray', 'gui-icons', 'gui-footer-icon-buttons-icon', 'gui-block']">&#xe6fe;
</text>
