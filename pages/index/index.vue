    ...
    <template v-slot:gBody>
      <view class="gui-flex gui-m-l-20 gui-m-b-20">
        <view class="gui-bg-white gui-dark-bg-level-3 gui-p-r-20"
          ><gui-switch-navigation :items="navItems" @change="navchange" :width="640"></gui-switch-navigation
        ></view>
        <view class="gui-m-l-10 gui-m-t-5"
          ><text class="gui-icons gui-block gui-color-drak gui-p-10 gui-b-100 gui-bg-black4">&#xe614;</text></view
        >
      </view>
