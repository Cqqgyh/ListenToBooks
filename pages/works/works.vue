  ...
  <gui-page :customHeader="true">
    ...
    <template v-slot:gHeader>
      <view style="height: 44px" class="gui-flex gui-nowrap gui-rows gui-align-items-center">
        ...
        <view class="gui-flex"
          ><text class="gui-icons gui-block gui-color-drak gui-p-10 gui-b-50 gui-bg-black-opacity3 gui-m-r-10"
            >&#xe6c7;</text
          ></view
        >
          ...
          <view class="gui-card-body gui-border-b gui-flex gui-rows gui-nowrap">
            ...
            <view class="gui-card-desc">
              ...
              <view class="gui-flex gui-space-around gui-m-t-20 gui-color-gray gui-text-small">
                <text class="gui-icons gui-block gui-m-r-10">&#xe800; <text class="gui-m-l-10">21</text></text>
                <text class="gui-icons gui-block gui-m-r-10">&#xe67b; <text class="gui-m-l-10">14</text></text>
